 ...
 */
final class Version20200804104354 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(400) NOT NULL, email VARCHAR(255) NOT NULL, email_hash VARCHAR(500) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, type SMALLINT DEFAULT 2 NOT NULL, position VARCHAR(255) DEFAULT NULL, id_author INT NOT NULL, status SMALLINT DEFAULT 1 NOT NULL, avatar VARCHAR(400) DEFAULT NULL, roles VARCHAR(255) NOT NULL, salt VARCHAR(255) NOT NULL, INDEX index_id (id) USING BTREE, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
